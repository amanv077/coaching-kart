      ...
      <div className="container mx-auto px-4 pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-24">
          <div className="bg-gradient-to-br from-coaching-primary/10 to-coaching-accent/10 p-8 rounded-2xl">
            <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <span className="text-coaching-primary text-3xl">🔭</span> Our Vision
            </h2>
            <p className="text-lg leading-relaxed text-foreground/90">
              To create a world where every student has equal access to high-quality education, 
              regardless of their location or economic background. We envision a future where finding 
              the right coaching is easy, transparent, and affordable for all.
            </p>
          </div>
          <div className="bg-gradient-to-br from-coaching-accent/10 to-coaching-primary/10 p-8 rounded-2xl">
            <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <span className="text-coaching-accent text-3xl">🎯</span> Our Mission
            </h2>
            <p className="text-lg leading-relaxed text-foreground/90">
              To bridge the gap between students and coaching institutes by building a platform that 
              offers unbiased information, verified reviews, and exclusive discounts. We're committed to 
              transforming how students discover, compare, and access educational resources.
            </p>
          </div>
        </div>
        ...
        <div className="mb-24 bg-gradient-to-r from-coaching-primary/5 to-coaching-accent/5 rounded-3xl p-8 md:p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">The difference we're making in education</p>
          </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Passionate educators, technologists, and changemakers committed to transforming education access
            </p>
          </div>
        ...
        <div className="text-center bg-gradient-to-br from-coaching-primary/10 via-transparent to-coaching-accent/10 rounded-3xl p-8 md:p-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            Whether you're a student seeking the best education, a coaching institute looking to reach more students, or a passionate individual wanting to join our team — we'd love to connect with you.
          </p>
